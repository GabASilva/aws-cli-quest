...
(function () {
  ...
  const DESAFIOS_FASE2 = [
    ...
    { id: "sqs-1", servico: "sqs", nivel: 1, xp: 40, titulo: "Tem alguma fila aí?",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws sqs help"], solucao: ["aws sqs list-queues"],
    ...
    { id: "sqs-2", servico: "sqs", nivel: 1, xp: 60, titulo: "Sua primeira fila",
      ...
      dicas: ["aws sqs create-queue --queue-name <nome>", "Guarde a QueueUrl que aparece: é ela que os outros comandos pedem."],
    ...
    { id: "sqs-3", servico: "sqs", nivel: 2, xp: 70, titulo: "Mande um pedido pra fila",
      ...
      dicas: ["`send-…` envia algo (mensagem, evento) — veja a lista de comandos com: aws sqs help", "A forma do comando é: aws sqs send-message --queue-url <endereço> --message-body <a mensagem>"],
    ...
    { id: "sqs-4", servico: "sqs", nivel: 2, xp: 60, titulo: "Quantos pedidos esperando?",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws sqs help", "A forma do comando é: aws sqs get-queue-attributes --queue-url <endereço> --attribute-names <valor>"],
    ...
    { id: "sqs-5", servico: "sqs", nivel: 2, xp: 70, titulo: "Puxe o pedido pra processar",
      ...
      dicas: ["`receive-…` lê o que chegou — veja a lista de comandos com: aws sqs help", "A forma do comando é: aws sqs receive-message --queue-url <endereço>"],
    ...
    { id: "sqs-6", servico: "sqs", nivel: 3, xp: 90, titulo: "Confirme que processou",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws sqs help", "A forma do comando é: aws sqs delete-message --queue-url <endereço> --receipt-handle <valor>", "Copie o ReceiptHandle da saída anterior."],
    ...
    { id: "sqs-7", servico: "sqs", nivel: 3, xp: 80, titulo: "Fila FIFO (ordem garantida)",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws sqs help", "A forma do comando é: aws sqs create-queue --queue-name <nome> --attributes <atributos>"],
    ...
    { id: "sqs-8", servico: "sqs", nivel: 3, xp: 70, titulo: "Faxina na fila",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws sqs help", "A forma do comando é: aws sqs delete-queue --queue-url <endereço>"],
    ...
    { id: "sns-1", servico: "sns", nivel: 1, xp: 40, titulo: "Quais tópicos existem?",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws sns help"], solucao: ["aws sns list-topics"],
    ...
    { id: "sns-2", servico: "sns", nivel: 1, xp: 60, titulo: "Crie o tópico de alertas",
      ...
      dicas: ["aws sns create-topic --name <nome>", "Guarde o TopicArn — os outros comandos pedem ele."],
    ...
    { id: "sns-3", servico: "sns", nivel: 2, xp: 80, titulo: "Avise a equipe por e-mail",
      ...
      dicas: ["Veja os comandos disponíveis com: aws sns help", "A forma do comando é: aws sns subscribe --topic-arn <arn> --protocol <tipo> --notification-endpoint <endereço>", "Na AWS real a pessoa recebe um link de confirmação — por isso o retorno é 'pending confirmation'."],
    ...
    { id: "sns-4", servico: "sns", nivel: 2, xp: 70, titulo: "Publique o primeiro aviso",
      ...
      dicas: ["Veja os comandos disponíveis com: aws sns help", "A forma do comando é: aws sns publish --topic-arn <arn> --message <a mensagem>"],
    ...
    { id: "sns-5", servico: "sns", nivel: 2, xp: 60, titulo: "Quem está inscrito?",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws sns help", "A forma do comando é: aws sns list-subscriptions-by-topic --topic-arn <arn>"],
    ...
    { id: "sns-6", servico: "sns", nivel: 3, xp: 100, titulo: "Fan-out: SNS ➜ SQS",
      ...
      dicas: ["Veja os comandos disponíveis com: aws sns help", "A forma do comando é: aws sns subscribe --topic-arn <arn> --protocol <tipo> --notification-endpoint <endereço>", "O ARN da fila é arn:aws:sqs:us-east-1:123456789012:pedidos-novos"],
    ...
    { id: "sns-7", servico: "sns", nivel: 3, xp: 90, titulo: "Veja o fan-out funcionando",
      ...
      dicas: ["Veja os comandos disponíveis com: aws sns help", "A forma do comando é: aws sns publish --topic-arn <arn> --message <a mensagem>  →  aws sqs get-queue-attributes --queue-url <endereço> --attribute-names <valor>"],
    ...
    { id: "sns-8", servico: "sns", nivel: 3, xp: 70, titulo: "Desligue o megafone",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws sns help", "A forma do comando é: aws sns delete-topic --topic-arn <arn>"],
    ...
    { id: "ebs-1", servico: "ebs", nivel: 1, xp: 50, titulo: "Que discos eu tenho?",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ec2 help"], solucao: ["aws ec2 describe-volumes"],
    ...
    { id: "ebs-2", servico: "ebs", nivel: 1, xp: 70, titulo: "Crie um disco de 10 GB",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 create-volume --availability-zone <zona> --size <número> --volume-type <tipo>"],
    ...
    { id: "ebs-3", servico: "ebs", nivel: 2, xp: 80, titulo: "Encaixe o disco na máquina",
      ...
      dicas: ["Ids: aws ec2 describe-volumes e aws ec2 describe-instances", "aws ec2 attach-volume --volume-id <id> --instance-id <id> --device <valor>"],
    ...
    { id: "ebs-4", servico: "ebs", nivel: 2, xp: 80, titulo: "Backup: tire um snapshot",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 create-snapshot --volume-id <id> --description <descrição>"],
    ...
    { id: "ebs-5", servico: "ebs", nivel: 2, xp: 50, titulo: "Confira seus backups",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ec2 help"], solucao: ["aws ec2 describe-snapshots"],
    ...
    { id: "ebs-6", servico: "ebs", nivel: 3, xp: 80, titulo: "Tire o disco da máquina",
      ...
      dicas: ["`detach-…` desconecta — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 detach-volume --volume-id <id>"],
    ...
    { id: "ebs-7", servico: "ebs", nivel: 3, xp: 80, titulo: "Descarte o disco",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 delete-volume --volume-id <id>"],
    ...
    { id: "apigw-1", servico: "apigateway", nivel: 1, xp: 50, titulo: "Tem alguma API publicada?",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws apigateway help"], solucao: ["aws apigateway get-rest-apis"],
    ...
    { id: "apigw-2", servico: "apigateway", nivel: 1, xp: 70, titulo: "Crie a API da loja",
      ...
      dicas: ["aws apigateway create-rest-api --name <nome>", "Guarde o id que volta — todo comando seguinte pede ele."],
    ...
    { id: "apigw-3", servico: "apigateway", nivel: 2, xp: 70, titulo: "Ache a raiz da API",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws apigateway help", "A forma do comando é: aws apigateway get-resources --rest-api-id <id>"],
    ...
    { id: "apigw-4", servico: "apigateway", nivel: 2, xp: 90, titulo: "Crie o caminho /pedidos",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws apigateway help", "A forma do comando é: aws apigateway create-resource --rest-api-id <id> --parent-id <id> --path-part <valor>"],
    ...
    { id: "apigw-5", servico: "apigateway", nivel: 2, xp: 90, titulo: "Aceite requisições GET",
      ...
      dicas: ["`put-…` grava/substitui uma configuração (é o \"salvar\" do CLI) — veja a lista de comandos com: aws apigateway help", "A forma do comando é: aws apigateway put-method --rest-api-id <id> --resource-id <id> --http-method <tipo> --authorization-type <tipo>"],
    ...
    { id: "apigw-6", servico: "apigateway", nivel: 3, xp: 100, titulo: "Publique no ar (estágio prod)",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws apigateway help", "A forma do comando é: aws apigateway create-deployment --rest-api-id <id> --stage-name <nome>"],
    ...
    { id: "apigw-7", servico: "apigateway", nivel: 3, xp: 70, titulo: "Derrube a API",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws apigateway help", "A forma do comando é: aws apigateway delete-rest-api --rest-api-id <id>"],
    ...
    { id: "r53-1", servico: "route53", nivel: 1, xp: 40, titulo: "Quais domínios eu administro?",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws route53 help"], solucao: ["aws route53 list-hosted-zones"],
    ...
    { id: "r53-2", servico: "route53", nivel: 1, xp: 80, titulo: "Crie a zona do domínio",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws route53 help", "A forma do comando é: aws route53 create-hosted-zone --name <nome> --caller-reference <valor>"],
    ...
    { id: "r53-3", servico: "route53", nivel: 2, xp: 70, titulo: "O que já tem na zona?",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws route53 help", "A forma do comando é: aws route53 list-resource-record-sets --hosted-zone-id <id>"],
    ...
    { id: "r53-4", servico: "route53", nivel: 3, xp: 100, titulo: "Aponte www pro servidor",
      ...
      dicas: ["`change-…` aplica uma alteração — veja a lista de comandos com: aws route53 help", "A forma do comando é: aws route53 change-resource-record-sets --hosted-zone-id <id> --change-batch <json da mudança>"],
    ...
    { id: "r53-6", servico: "route53", nivel: 3, xp: 80, titulo: "Devolva o domínio",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws route53 help", "A forma do comando é: aws route53 delete-hosted-zone --id <id>"],
    ...
    { id: "cf-1", servico: "cloudfront", nivel: 1, xp: 40, titulo: "Alguma CDN no ar?",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws cloudfront help"], solucao: ["aws cloudfront list-distributions"],
    ...
    { id: "cf-2", servico: "cloudfront", nivel: 2, xp: 90, titulo: "Coloque o site na CDN",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws cloudfront help", "A forma do comando é: aws cloudfront create-distribution --origin-domain-name <nome>"],
    ...
    { id: "cf-3", servico: "cloudfront", nivel: 2, xp: 70, titulo: "Qual é o endereço da CDN?",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws cloudfront help", "A forma do comando é: aws cloudfront get-distribution --id <id>"],
    ...
    { id: "cf-4", servico: "cloudfront", nivel: 3, xp: 100, titulo: "Publiquei e não atualizou!",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws cloudfront help", "A forma do comando é: aws cloudfront create-invalidation --distribution-id <id> --paths <caminhos>"],
    ...
    { id: "cf-5", servico: "cloudfront", nivel: 3, xp: 80, titulo: "Histórico de limpezas",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws cloudfront help", "A forma do comando é: aws cloudfront list-invalidations --id <id>"],
