...
(function () {
  ...
  const DESAFIOS_FASE7 = [
    ...
    { id: "bud-1", servico: "budgets", nivel: 1, xp: 50, titulo: "Nunca mais tome susto na fatura",
      ...
      dicas: ["aws budgets describe-budgets --account-id 123456789012"],
    ...
    { id: "bud-2", servico: "budgets", nivel: 2, xp: 90, titulo: "Defina um teto mensal",
      ...
      dicas: [`aws budgets create-budget --account-id 123456789012 --budget '{"BudgetName":"orcamento-mensal","BudgetLimit":{"Amount":"50","Unit":"USD"},"TimeUnit":"MONTHLY","BudgetType":"COST"}'`],
    ...
    { id: "bud-4", servico: "budgets", nivel: 3, xp: 70, titulo: "Remova o orçamento",
      ...
      dicas: ["aws budgets delete-budget --account-id 123456789012 --budget-name orcamento-mensal"],
    ...
    { id: "ce-1", servico: "ce", nivel: 1, xp: 60, titulo: "Para onde vai o dinheiro?",
      ...
      dicas: [`aws ce get-cost-and-usage --time-period '{"Start":"2026-07-01","End":"2026-07-31"}' --granularity MONTHLY --metrics UnblendedCost`],
    ...
    { id: "ce-2", servico: "ce", nivel: 2, xp: 90, titulo: "Qual serviço está pesando?",
      ...
      dicas: [`aws ce get-cost-and-usage --time-period '{"Start":"2026-07-01","End":"2026-07-31"}' --granularity MONTHLY --metrics UnblendedCost --group-by Type=DIMENSION,Key=SERVICE`],
    ...
    { id: "ce-3", servico: "ce", nivel: 2, xp: 80, titulo: "Quanto vai fechar o mês?",
      ...
      dicas: [`aws ce get-cost-forecast --time-period '{"Start":"2026-07-24","End":"2026-08-01"}' --metric UNBLENDED_COST --granularity MONTHLY`],
    ...
    { id: "org-1", servico: "organizations", nivel: 1, xp: 60, titulo: "Uma conta pra cada time",
      ...
      dicas: ["aws organizations create-organization"], solucao: ["aws organizations create-organization"],
    ...
    { id: "org-2", servico: "organizations", nivel: 2, xp: 100, titulo: "Crie uma conta-filha",
      ...
      dicas: ["aws organizations create-account --account-name time-dados --email dados+aws@exemplo.com"],
    ...
    { id: "org-3", servico: "organizations", nivel: 2, xp: 70, titulo: "Quem está na organização?",
      ...
      dicas: ["aws organizations list-accounts"], solucao: ["aws organizations list-accounts"],
    ...
    { id: "org-4", servico: "organizations", nivel: 3, xp: 90, titulo: "Organize em pastas (OU)",
      ...
      dicas: ["aws organizations create-organizational-unit --name Producao --parent-id r-root"],
    ...
    { id: "ta-1", servico: "support", nivel: 1, xp: 60, titulo: "Seu consultor automático",
      ...
      dicas: ["aws support describe-trusted-advisor-checks --language pt"],
    ...
    { id: "ta-2", servico: "support", nivel: 2, xp: 90, titulo: "Alguma porta aberta demais?",
      ...
      dicas: ["aws support describe-trusted-advisor-check-result --check-id Qch7DwouX1 --language pt"],
