...
(function () {
  ...
  const DESAFIOS_LAB = [
    { id: "diag-1", servico: "diagnostico", nivel: 2, xp: 70, titulo: "O chamado chegou",
      ...
      dicas: ["curl http://<ip-do-servidor>", "Reproduzir o erro antes de mexer em qualquer coisa é o passo que mais gente pula."],
    ...
    { id: "diag-2", servico: "diagnostico", nivel: 2, xp: 80, titulo: "Ligue as câmeras (flow logs)",
      ...
      dicas: ["aws s3 mb s3://<nome-do-bucket>", "aws ec2 describe-vpcs", "aws ec2 create-flow-logs --resource-type <tipo> --resource-ids <id> --traffic-type <tipo> --log-destination-type <tipo> --log-destination <valor>"],
    ...
    { id: "diag-3", servico: "diagnostico", nivel: 2, xp: 70, titulo: "Confirme que está gravando",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ec2 help"], solucao: ["aws ec2 describe-flow-logs"],
    ...
    { id: "diag-4", servico: "diagnostico", nivel: 3, xp: 90, titulo: "Descarte a hipótese óbvia",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ec2 help"], solucao: ["aws ec2 describe-security-groups"],
    ...
    { id: "diag-5", servico: "diagnostico", nivel: 3, xp: 100, titulo: "Siga o caminho do pacote",
      ...
      dicas: ["Pra ver as tabelas de rota o verbo é `describe-…` — veja: aws ec2 help", "Uma sub-rede PÚBLICA precisa de uma rota 0.0.0.0/0 apontando pro internet gateway. Está lá?"],
    ...
    { id: "diag-6", servico: "diagnostico", nivel: 3, xp: 120, titulo: "Conserto #1: a rota que faltava",
      ...
      dicas: ["aws ec2 describe-internet-gateways", "aws ec2 create-route --route-table-id <id> --gateway-id <id> --destination-cidr-block <valor>"],
    ...
    { id: "diag-7", servico: "diagnostico", nivel: 3, xp: 80, titulo: "O site voltou?",
      ...
      dicas: ["`curl` busca uma URL pelo terminal — é o jeito de \"abrir o site\" sem navegador, pra testar se ele responde.", "A forma é: curl http://<ip-do-servidor>"], solucao: ["curl http://198.51.100.42"],
    ...
    { id: "diag-8", servico: "diagnostico", nivel: 3, xp: 90, titulo: "Mas o SSH continua morto",
      ...
      dicas: ["nmap <ip-do-servidor>", "Se uma porta abre e a outra não, o bloqueio é específico daquela porta."],
    ...
    { id: "diag-9", servico: "diagnostico", nivel: 3, xp: 110, titulo: "O firewall que quase ninguém lembra",
      ...
      dicas: ["As network ACLs também se listam com `describe-…` — veja: aws ec2 help", "Na network ACL vale a regra de MENOR número que casar — procure uma regra baixa com deny."],
    ...
    { id: "diag-10", servico: "diagnostico", nivel: 3, xp: 130, titulo: "Conserto #2: remova a regra sabotadora",
      ...
      dicas: ["aws ec2 delete-network-acl-entry --network-acl-id <id> --ingress --rule-number <valor>", "O --ingress diz que é regra de ENTRADA (a de saída seria --egress)."],
    ...
    { id: "diag-11", servico: "diagnostico", nivel: 3, xp: 90, titulo: "Entre no servidor",
      ...
      dicas: ["`ssh` abre um terminal remoto dentro da máquina — é assim que se entra num servidor Linux.", "A forma é: ssh <ip-do-servidor>"], solucao: ["ssh 198.51.100.42"],
    ...
    { id: "diag-13", servico: "diagnostico", nivel: 4, xp: 150, titulo: "Cace os REJECT",
      ...
      dicas: ["Primeiro veja o arquivo inteiro (cat <arquivo>), depois filtre (grep <texto> <arquivo>).", "Repare que as rejeições são na porta 22 — exatamente o que a network ACL bloqueava."],
