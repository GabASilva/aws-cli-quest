...
(function () {
  ...
  const DESAFIOS_FASE5 = [
    ...
    { id: "ct-1", servico: "cloudtrail", nivel: 1, xp: 50, titulo: "Quem mexeu na conta?",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws cloudtrail help"], solucao: ["aws cloudtrail describe-trails"],
    ...
    { id: "ct-2", servico: "cloudtrail", nivel: 2, xp: 80, titulo: "Onde guardar as gravações",
      ...
      dicas: ["Primeiro: aws s3 mb s3://<nome-do-bucket>", "Depois: aws cloudtrail create-trail --name <nome> --s3-bucket-name <nome>"],
    ...
    { id: "ct-3", servico: "cloudtrail", nivel: 2, xp: 70, titulo: "Ligue a câmera",
      ...
      dicas: ["`start-…` põe pra rodar algo que já existe — veja a lista de comandos com: aws cloudtrail help", "A forma do comando é: aws cloudtrail start-logging --name <nome>"],
    ...
    { id: "ct-4", servico: "cloudtrail", nivel: 2, xp: 60, titulo: "Está mesmo gravando?",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws cloudtrail help", "A forma do comando é: aws cloudtrail get-trail-status --name <nome>"],
    ...
    { id: "ct-5", servico: "cloudtrail", nivel: 3, xp: 100, titulo: "Veja o seu próprio rastro",
      ...
      dicas: ["`lookup-…` procura dentro do histórico — veja a lista de comandos com: aws cloudtrail help"], solucao: ["aws cloudtrail lookup-events"],
    ...
    { id: "ct-6", servico: "cloudtrail", nivel: 3, xp: 100, titulo: "Investigue um evento específico",
      ...
      dicas: ["`lookup-…` procura dentro do histórico — veja a lista de comandos com: aws cloudtrail help", "A forma do comando é: aws cloudtrail lookup-events --lookup-attributes <por que atributo filtrar>"],
    ...
    { id: "ssm-1", servico: "ssm", nivel: 1, xp: 50, titulo: "A gaveta de configurações",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ssm help"], solucao: ["aws ssm describe-parameters"],
    ...
    { id: "ssm-2", servico: "ssm", nivel: 1, xp: 70, titulo: "Guarde a URL da API",
      ...
      dicas: ["`put-…` grava/substitui uma configuração (é o \"salvar\" do CLI) — veja a lista de comandos com: aws ssm help", "A forma do comando é: aws ssm put-parameter --name <nome> --value <valor> --type <tipo>"],
    ...
    { id: "ssm-3", servico: "ssm", nivel: 2, xp: 70, titulo: "Leia a configuração",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws ssm help", "A forma do comando é: aws ssm get-parameter --name <nome>"],
    ...
    { id: "ssm-5", servico: "ssm", nivel: 3, xp: 90, titulo: "Peça pra decifrar",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws ssm help", "A forma do comando é: aws ssm get-parameter --name <nome> --with-decryption"],
    ...
    { id: "ssm-6", servico: "ssm", nivel: 3, xp: 100, titulo: "Toda a config de uma vez",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws ssm help", "A forma do comando é: aws ssm get-parameters-by-path --path <caminho>"],
    ...
    { id: "cog-1", servico: "cognito-idp", nivel: 1, xp: 60, titulo: "Login pronto, sem código",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws cognito-idp help", "A forma do comando é: aws cognito-idp list-user-pools --max-results <número>"],
    ...
    { id: "cog-2", servico: "cognito-idp", nivel: 2, xp: 80, titulo: "Crie o banco de usuários",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws cognito-idp help", "A forma do comando é: aws cognito-idp create-user-pool --pool-name <nome>"],
    ...
    { id: "cog-3", servico: "cognito-idp", nivel: 2, xp: 70, titulo: "Detalhes do pool",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws cognito-idp help", "A forma do comando é: aws cognito-idp describe-user-pool --user-pool-id <id>"],
    ...
    { id: "cog-4", servico: "cognito-idp", nivel: 2, xp: 90, titulo: "Registre o seu app",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws cognito-idp help", "A forma do comando é: aws cognito-idp create-user-pool-client --user-pool-id <id> --client-name <nome>"],
    ...
    { id: "cog-5", servico: "cognito-idp", nivel: 3, xp: 90, titulo: "Cadastre a primeira pessoa",
      ...
      dicas: ["comandos `admin-…` são as ações administrativas (feitas por você, não pelo usuário final) — veja a lista de comandos com: aws cognito-idp help", "A forma do comando é: aws cognito-idp admin-create-user --user-pool-id <id> --username <valor>"],
    ...
    { id: "cog-6", servico: "cognito-idp", nivel: 3, xp: 70, titulo: "Quem já se cadastrou?",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws cognito-idp help", "A forma do comando é: aws cognito-idp list-users --user-pool-id <id>"],
    ...
    { id: "cog-7", servico: "cognito-idp", nivel: 3, xp: 80, titulo: "Encerre o pool",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws cognito-idp help", "A forma do comando é: aws cognito-idp delete-user-pool --user-pool-id <id>"],
    ...
    { id: "asg-1", servico: "autoscaling", nivel: 1, xp: 60, titulo: "A receita da máquina",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 create-launch-template --launch-template-name <nome> --launch-template-data <json do modelo>"],
    ...
    { id: "asg-2", servico: "autoscaling", nivel: 2, xp: 100, titulo: "Crie o grupo elástico",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws autoscaling help", "A forma do comando é: aws autoscaling create-auto-scaling-group --auto-scaling-group-name <nome> --launch-template <valor> --min-size <número> --max-size <número> --desired-capacity <número> --availability-zones <zonas>"],
    ...
    { id: "asg-3", servico: "autoscaling", nivel: 2, xp: 70, titulo: "As máquinas apareceram mesmo?",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ec2 help"], solucao: ["aws ec2 describe-instances"],
    ...
    { id: "asg-4", servico: "autoscaling", nivel: 2, xp: 90, titulo: "Chegou a Black Friday",
      ...
      dicas: ["`set-…` define um valor — veja a lista de comandos com: aws autoscaling help", "A forma do comando é: aws autoscaling set-desired-capacity --auto-scaling-group-name <nome> --desired-capacity <número>"],
    ...
    { id: "asg-6", servico: "autoscaling", nivel: 3, xp: 100, titulo: "Deixe ele se virar sozinho",
      ...
      dicas: ["`put-…` grava/substitui uma configuração (é o \"salvar\" do CLI) — veja a lista de comandos com: aws autoscaling help", "A forma do comando é: aws autoscaling put-scaling-policy --auto-scaling-group-name <nome> --policy-name <nome> --policy-type <tipo>"],
    ...
    { id: "asg-7", servico: "autoscaling", nivel: 3, xp: 90, titulo: "Desmonte o grupo",
      ...
      dicas: ["Zere: aws autoscaling update-auto-scaling-group --auto-scaling-group-name <nome> --min-size <número> --desired-capacity <número>", "Depois: aws autoscaling delete-auto-scaling-group --auto-scaling-group-name <nome>"],
