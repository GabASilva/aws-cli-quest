  ...
  const NOVIDADES = [
    {
      ...
      itens: [
        ...
        "<b>🎛️ Escolha quais trilhas aparecem na lista.</b> No topo da lista da esquerda, o botão <b>Escolher trilhas</b> abre todas as trilhas por grupo: marque só o que você está estudando. Tem atalho pra <i>só as grátis</i>, <i>só as que já comecei</i> e por carreira (DevOps, Backend, Dados…). As outras não somem do app — um clique em <i>mostrar todas</i> traz tudo de volta, e trilha nova que entrar aparece sozinha.",
