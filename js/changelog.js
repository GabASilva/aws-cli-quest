  ...
  const NOVIDADES = [
    {
      ...
      itens: [
        ...
        "<b>📊 Métrica personalizada no CloudWatch — conteúdo novo.</b> Até agora o CLImb só falava das métricas que a AWS coleta sozinha (CPU, invocações). Faltava o outro lado: <b>publicar a SUA métrica</b>. São <b>5 atividades novas</b> ensinando a mandar um número de negócio (pedidos por minuto) com <b>put-metric-data</b>, lê-lo de volta agregado com <b>get-metric-statistics</b> (Sum, Average, Maximum) e <b>criar alarme em cima dela</b>, igual a qualquer métrica da AWS. Inclusive o erro que todo mundo comete: namespace começando com <b>AWS/</b>, que é reservado.",
