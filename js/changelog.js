  ...
  const NOVIDADES = [
    {
      ...
      itens: [
        ...
        "<b>📊 CloudWatch completo — 16 atividades novas.</b> A trilha agora conta a história inteira da observabilidade: <b>meço → alarmo → visualizo → investigo</b>.",
        ...
        "• <b>Consulta de log (Logs Insights):</b> a trilha criava grupos de log mas nunca <b>lia</b> um — e ler log é o que se faz num plantão. Agora tem os dois jeitos: <b>filter-log-events</b> (a busca simples por texto) e o <b>Logs Insights</b>, com linguagem de consulta de verdade — <code>filter</code>, <code>stats count() by</code>, <code>sort</code>, <code>limit</code>. O motor <b>roda a sua consulta</b> sobre os eventos: consulta diferente dá resposta diferente, não é resultado enlatado. Você descobre <b>quantos erros de cada tipo</b> e <b>qual rota está mais lenta</b>, e aprende que o Insights cobra pelo volume <b>escaneado</b> — por isso se filtra cedo, não no fim.",
