  ...
  const NOVIDADES = [
    {
      ...
      itens: [
        "<b>🔓 Todas as atividades abertas: faça na ordem que quiser.</b> Nenhuma atividade espera mais a anterior — quer praticar um comando específico ou treinar antes de começar a trilha? Abra direto. A ordem da trilha continua lá como sugestão: a lista mostra as próximas e esconde o resto numa linha que abre com um clique. E se você pular etapas, o card avisa: algumas atividades usam o que as anteriores criaram. (O limite do plano grátis continua o mesmo.)",
