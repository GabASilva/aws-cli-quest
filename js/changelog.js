  ...
  const NOVIDADES = [
    {
      ...
      itens: [
        ...
        "<b>🧩 E as trilhas do dia se encaixam:</b> a atividade do <b>instance profile</b> fecha o ciclo com a do Systems Manager. Aquela instância que não aparecia na lista? Máquina EC2 não recebe role direto — recebe um instance profile que carrega a role. É a mesma peça, vista dos dois lados. A trilha de IAM foi de 22 para 37 atividades, e o curso passou de 690 para <b>787</b> nesta semana.",
      ],
    },
    {
      versao: "2026-09-21",
