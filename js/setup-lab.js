...
const DESAFIOS_SETUP = [
  {
    ...
    dicas: ["Primeiro proteja a chave: chmod 400 <arquivo.pem> (deixa o arquivo legível só pra você).", "Depois conecte no formato: ssh -i <chave> <usuário>@<ip>"],
  ...
  },
  {
    ...
    dicas: ["curl \"<url>\" -o \"<arquivo-de-saida>\"", "A URL do instalador está no enunciado; o -o diz com que nome salvar."],
  ...
  },
  {
    ...
    dicas: ["O instalador vem compactado em .zip — `unzip` descompacta. A opção `-u` atualiza arquivos que já existam.", "A forma é: unzip -u <arquivo.zip>"],
  ...
  },
  {
    ...
    dicas: ["sudo dá a permissão de escrita necessária pra instalar.", "A forma é: sudo <caminho-do-instalador>"],
  ...
  },
  {
    ...
    dicas: ["Quase toda ferramenta de linha de comando responde a uma opção que mostra a versão instalada — ela começa com dois hífens."],
    solucao: ["aws --version"],
  ...
  },
  {
    ...
    dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws iam help"],
