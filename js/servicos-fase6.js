...
(function () {
  ...
  const DESAFIOS_FASE6 = [
    ...
    { id: "elb-1", servico: "elbv2", nivel: 1, xp: 50, titulo: "Quem distribui o tráfego?",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws elbv2 help"], solucao: ["aws elbv2 describe-load-balancers"],
    ...
    { id: "elb-2", servico: "elbv2", nivel: 2, xp: 90, titulo: "Suba o balanceador",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws elbv2 help", "A forma do comando é: aws elbv2 create-load-balancer --name <nome> --subnets <duas sub-redes>"],
    ...
    { id: "elb-3", servico: "elbv2", nivel: 2, xp: 90, titulo: "O grupo de destino",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws elbv2 help", "A forma do comando é: aws elbv2 create-target-group --name <nome> --protocol <tipo> --port <número> --vpc-id <id>"],
    ...
    { id: "elb-4", servico: "elbv2", nivel: 3, xp: 100, titulo: "Registre as máquinas",
      ...
      dicas: ["Primeiro: aws ec2 run-instances --image-id <id> --instance-type <tipo>", "aws elbv2 register-targets --target-group-arn <arn> --targets <Id=…>"],
    ...
    { id: "elb-5", servico: "elbv2", nivel: 3, xp: 90, titulo: "Abra a porta de entrada (listener)",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws elbv2 help", "A forma do comando é: aws elbv2 create-listener --load-balancer-arn <arn> --protocol <tipo> --port <número> --default-actions <para onde encaminhar>"],
    ...
    { id: "elb-6", servico: "elbv2", nivel: 2, xp: 60, titulo: "As máquinas estão saudáveis?",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws elbv2 help", "A forma do comando é: aws elbv2 describe-target-health --target-group-arn <arn>"],
    ...
    { id: "elb-7", servico: "elbv2", nivel: 3, xp: 80, titulo: "Desmonte o balanceador",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws elbv2 help", "A forma do comando é: aws elbv2 delete-load-balancer --load-balancer-arn <arn>"],
    ...
    { id: "bs-1", servico: "elasticbeanstalk", nivel: 1, xp: 50, titulo: "Deploy sem dor de cabeça",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws elasticbeanstalk help"], solucao: ["aws elasticbeanstalk describe-applications"],
    ...
    { id: "bs-2", servico: "elasticbeanstalk", nivel: 1, xp: 70, titulo: "Crie a aplicação",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws elasticbeanstalk help", "A forma do comando é: aws elasticbeanstalk create-application --application-name <nome>"],
    ...
    { id: "bs-3", servico: "elasticbeanstalk", nivel: 2, xp: 100, titulo: "Coloque no ar (environment)",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws elasticbeanstalk help", "A forma do comando é: aws elasticbeanstalk create-environment --application-name <nome> --environment-name <nome> --solution-stack-name <plataforma>"],
    ...
    { id: "bs-4", servico: "elasticbeanstalk", nivel: 2, xp: 60, titulo: "Está no ar e saudável?",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws elasticbeanstalk help"], solucao: ["aws elasticbeanstalk describe-environments"],
    ...
    { id: "bs-5", servico: "elasticbeanstalk", nivel: 3, xp: 90, titulo: "Encerre tudo de uma vez",
      ...
      dicas: ["Primeiro: aws elasticbeanstalk terminate-environment --environment-name <nome>", "Depois: aws elasticbeanstalk delete-application --application-name <nome>"],
    ...
    { id: "efs-1", servico: "efs", nivel: 1, xp: 50, titulo: "Disco compartilhado",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws efs help"], solucao: ["aws efs describe-file-systems"],
    ...
    { id: "efs-2", servico: "efs", nivel: 1, xp: 70, titulo: "Crie o file system",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws efs help", "A forma do comando é: aws efs create-file-system --creation-token <valor>"],
    ...
    { id: "efs-3", servico: "efs", nivel: 2, xp: 90, titulo: "Ponto de conexão na rede",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws efs help", "A forma do comando é: aws efs create-mount-target --file-system-id <id> --subnet-id <id>"],
    ...
    { id: "efs-4", servico: "efs", nivel: 3, xp: 80, titulo: "Descarte o disco",
      ...
      dicas: ["Primeiro: aws efs delete-mount-target --mount-target-id <id>", "Depois: aws efs delete-file-system --file-system-id <id>"],
    ...
    { id: "cache-1", servico: "elasticache", nivel: 1, xp: 50, titulo: "Memória que acelera",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws elasticache help"], solucao: ["aws elasticache describe-cache-clusters"],
    ...
    { id: "cache-2", servico: "elasticache", nivel: 2, xp: 90, titulo: "Suba um Redis",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws elasticache help", "A forma do comando é: aws elasticache create-cache-cluster --cache-cluster-id <id> --engine <tipo> --cache-node-type <tipo> --num-cache-nodes <número>"],
    ...
    { id: "cache-3", servico: "elasticache", nivel: 3, xp: 70, titulo: "Desligue o cache",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws elasticache help", "A forma do comando é: aws elasticache delete-cache-cluster --cache-cluster-id <id>"],
    ...
    { id: "acm-1", servico: "acm", nivel: 1, xp: 50, titulo: "Cadeado do HTTPS",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws acm help"], solucao: ["aws acm list-certificates"],
    ...
    { id: "acm-2", servico: "acm", nivel: 2, xp: 80, titulo: "Peça o certificado",
      ...
      dicas: ["`request-…` pede algo à AWS (que pode demorar a ficar pronto) — veja a lista de comandos com: aws acm help", "A forma do comando é: aws acm request-certificate --domain-name <nome> --validation-method <como validar>"],
    ...
    { id: "acm-3", servico: "acm", nivel: 2, xp: 70, titulo: "Ainda validando?",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws acm help", "A forma do comando é: aws acm describe-certificate --certificate-arn <arn>"],
    ...
    { id: "acm-4", servico: "acm", nivel: 3, xp: 70, titulo: "Revogue o certificado",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws acm help", "A forma do comando é: aws acm delete-certificate --certificate-arn <arn>"],
