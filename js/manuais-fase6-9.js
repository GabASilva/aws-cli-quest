...
SERVIÇOS DAS FASES 6–9
  ...
  Object.assign(MANUAIS, {
    ...
    "configservice.stop-configuration-recorder": M("aws configservice stop-configuration-recorder --configuration-recorder-name default", "Para a gravação. O gravador continua existindo (dá pra ligar de novo com o\nstart), mas mudança feita enquanto ele está parado NÃO entra no histórico.\n\nEm conta de laboratório, é assim que se corta o custo do Config. Em conta\nde produção, gravador parado é alerta de segurança."),
