...
const RELAMPAGO_EXTRA = [
  // S3
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Bucket de mídia", descricao: "Crie o bucket <b>midia-2026</b>.", dicas: ["Veja os comandos disponíveis com: aws s3 help", "A forma do comando é: aws s3 mb s3://<nome-do-bucket>"], solucao: ["aws s3 mb s3://midia-2026"], validar: (c) => _b(c, "midia-2026") },
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Bucket de relatórios", descricao: "Crie o bucket <b>relatorios-q1</b>.", dicas: ["Veja os comandos disponíveis com: aws s3 help", "A forma do comando é: aws s3 mb s3://<nome-do-bucket>"], solucao: ["aws s3 mb s3://relatorios-q1"], validar: (c) => _b(c, "relatorios-q1") },
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Liste os buckets", descricao: "Liste todos os seus buckets.", dicas: ["Veja os comandos disponíveis com: aws s3 help"], solucao: ["aws s3 ls"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "s3", "ls") && cmd.posicionais.length === 0 },
  { servico: "extras-relampago", nivel: 2, xp: 40, titulo: "Buckets em JSON", descricao: "Liste os buckets pelo <b>s3api</b> (saída JSON).", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws s3api help"], solucao: ["aws s3api list-buckets"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "s3api", "list-buckets") },
  // EC2
  { servico: "extras-relampago", nivel: 2, xp: 40, titulo: "Suba uma t2.nano", descricao: "Suba uma instância <b>t2.nano</b> (imagem ami-0abcd1234ef567890).", dicas: ["`run-…` cria e já põe pra rodar — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 run-instances --image-id <id> --instance-type <tipo>"], solucao: ["aws ec2 run-instances --image-id ami-0abcd1234ef567890 --instance-type t2.nano"], validar: (c) => _inst(c, "t2.nano") },
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Chave de deploy", descricao: "Crie o par de chaves <b>deploy-key</b>.", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 create-key-pair --key-name <nome>"], solucao: ["aws ec2 create-key-pair --key-name deploy-key"], validar: (c) => _k(c, "deploy-key") },
  { servico: "extras-relampago", nivel: 2, xp: 40, titulo: "Grupo de segurança da API", descricao: "Crie o security group <b>api-sg</b> (descrição livre).", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 create-security-group --group-name <nome> --description <descrição>"], solucao: ['aws ec2 create-security-group --group-name api-sg --description "API"'], validar: (c) => _sg(c, "api-sg") },
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Veja as instâncias", descricao: "Liste as instâncias EC2.", dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ec2 help"], solucao: ["aws ec2 describe-instances"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "ec2", "describe-instances") },
  { servico: "extras-relampago", nivel: 2, xp: 40, titulo: "Liste os pares de chave", descricao: "Liste os key pairs da conta.", dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ec2 help"], solucao: ["aws ec2 describe-key-pairs"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "ec2", "describe-key-pairs") },
  // IAM
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Nova usuária: Carla", descricao: "Crie a usuária <b>carla</b>.", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-user --user-name <nome>"], solucao: ["aws iam create-user --user-name carla"], validar: (c) => _u(c, "carla") },
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Novo usuário: Diego", descricao: "Crie o usuário <b>diego</b>.", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-user --user-name <nome>"], solucao: ["aws iam create-user --user-name diego"], validar: (c) => _u(c, "diego") },
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Grupo de auditores", descricao: "Crie o grupo <b>auditores</b>.", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-group --group-name <nome>"], solucao: ["aws iam create-group --group-name auditores"], validar: (c) => _g(c, "auditores") },
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Quem está na conta?", descricao: "Liste os usuários IAM.", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws iam help"], solucao: ["aws iam list-users"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "iam", "list-users") },
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Liste os grupos", descricao: "Liste os grupos IAM.", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws iam help"], solucao: ["aws iam list-groups"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "iam", "list-groups") },
  { servico: "extras-relampago", nivel: 2, xp: 50, titulo: "Role pra EC2", descricao: "Crie a role <b>ec2-role</b> (use file://trust.json).", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-role --role-name <nome> --assume-role-policy-document <json de confiança>"], solucao: ["aws iam create-role --role-name ec2-role --assume-role-policy-document file://trust.json"], validar: (c) => _r(c, "ec2-role") },
  { servico: "extras-relampago", nivel: 2, xp: 40, titulo: "Liste as roles", descricao: "Liste as roles da conta.", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws iam help"], solucao: ["aws iam list-roles"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "iam", "list-roles") },
  { servico: "extras-relampago", nivel: 2, xp: 50, titulo: "Política só-leitura", descricao: "Crie a política <b>so-leitura</b> (file://politica-publica.json).", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-policy --policy-name <nome> --policy-document <json da política>"], solucao: ["aws iam create-policy --policy-name so-leitura --policy-document file://politica-publica.json"], validar: (c) => _p(c, "so-leitura") },
  { servico: "extras-relampago", nivel: 2, xp: 40, titulo: "Liste as políticas locais", descricao: "Liste as políticas gerenciadas pelo cliente.", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam list-policies --scope <tipo>"], solucao: ["aws iam list-policies --scope Local"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "iam", "list-policies") && cmd.flags.scope === "Local" },
  // Lambda
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Tem função aí?", descricao: "Liste as funções Lambda.", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws lambda help"], solucao: ["aws lambda list-functions"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "lambda", "list-functions") },
  { servico: "extras-relampago", nivel: 2, xp: 60, titulo: "Função de saudação", descricao: "Crie a função <b>saudacao</b> (python3.12, role arn:aws:iam::123456789012:role/papel-lambda, app.zip).", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws lambda help", "A forma do comando é: aws lambda create-function --function-name <nome> --runtime <linguagem> --role <valor> --handler <arquivo.função> --zip-file <fileb://arquivo.zip>"], solucao: ["aws lambda create-function --function-name saudacao --runtime python3.12 --role arn:aws:iam::123456789012:role/papel-lambda --handler app.handler --zip-file fileb://app.zip"], validar: (c) => _f(c, "saudacao") },
  // DynamoDB
  { servico: "extras-relampago", nivel: 2, xp: 50, titulo: "Tabela de produtos", descricao: "Crie a tabela <b>produtos-v2</b> (chave sku, texto).", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws dynamodb help", "A forma do comando é: aws dynamodb create-table --table-name <nome> --attribute-definitions <colunas-chave> --key-schema <chave primária> --billing-mode <tipo>"], solucao: ["aws dynamodb create-table --table-name produtos-v2 --attribute-definitions AttributeName=sku,AttributeType=S --key-schema AttributeName=sku,KeyType=HASH --billing-mode PAY_PER_REQUEST"], validar: (c) => _t(c, "produtos-v2") },
  ...
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Liste as tabelas", descricao: "Liste as tabelas do DynamoDB.", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws dynamodb help"], solucao: ["aws dynamodb list-tables"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "dynamodb", "list-tables") },
  // misc / combos rápidos
  { servico: "extras-relampago", nivel: 1, xp: 30, titulo: "Confirme a identidade", descricao: "Mostre a identidade da sessão (sts).", dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws sts help"], solucao: ["aws sts get-caller-identity"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "sts", "get-caller-identity") },
...
const BANCO = [
  // ----- fácil -----
  { nivel: 1, xp: 30, titulo: "Balde novo", descricao: "Crie o bucket <b>tr-balde</b>.", dicas: ["Veja os comandos disponíveis com: aws s3 help", "A forma do comando é: aws s3 mb s3://<nome-do-bucket>"], solucao: ["aws s3 mb s3://tr-balde"], validar: (c) => _b(c, "tr-balde") },
  { nivel: 1, xp: 30, titulo: "Usuário Kelly", descricao: "Crie o usuário <b>kelly</b>.", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-user --user-name <nome>"], solucao: ["aws iam create-user --user-name kelly"], validar: (c) => _u(c, "kelly") },
  { nivel: 1, xp: 30, titulo: "Grupo de estágio", descricao: "Crie o grupo <b>estagio</b>.", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-group --group-name <nome>"], solucao: ["aws iam create-group --group-name estagio"], validar: (c) => _g(c, "estagio") },
  { nivel: 1, xp: 30, titulo: "Chave de treino", descricao: "Crie o par de chaves <b>chave-tr</b>.", dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 create-key-pair --key-name <nome>"], solucao: ["aws ec2 create-key-pair --key-name chave-tr"], validar: (c) => _k(c, "chave-tr") },
  ...
  { nivel: 1, xp: 30, titulo: "Quem sou eu?", descricao: "Mostre a identidade da sessão.", dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws sts help"], solucao: ["aws sts get-caller-identity"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "sts", "get-caller-identity") },
  { nivel: 1, xp: 30, titulo: "Tabelas existentes", descricao: "Liste as tabelas do DynamoDB.", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws dynamodb help"], solucao: ["aws dynamodb list-tables"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "dynamodb", "list-tables") },
  { nivel: 1, xp: 30, titulo: "Funções existentes", descricao: "Liste as funções Lambda.", dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws lambda help"], solucao: ["aws lambda list-functions"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "lambda", "list-functions") },
  { nivel: 1, xp: 30, titulo: "Onde estou? (Linux)", descricao: "Mostre o diretório atual (comando Linux).", dicas: ["`pwd` é \"print working directory\": ele responde em que pasta você está agora."], solucao: ["pwd"], validar: (c, cmd, ok) => ok && cmd && cmd.servico === "linux" && cmd.sub === "pwd" },
  { nivel: 1, xp: 30, titulo: "Liste os arquivos (Linux)", descricao: "Liste os arquivos da pasta atual (comando Linux).", dicas: ["`ls` lista o que existe na pasta em que você está."], solucao: ["ls"], validar: (c, cmd, ok) => ok && cmd && cmd.servico === "linux" && cmd.sub === "ls" },
  { nivel: 1, xp: 40, titulo: "Crie uma pasta (Linux)", descricao: "Crie o diretório <b>tr-dir</b> (comando Linux).", dicas: ["`mkdir` é de \"make directory\" — criar pasta.", "A forma é: mkdir <nome-da-pasta>"], solucao: ["mkdir tr-dir"], validar: (c) => { const n = _fsno(c, "tr-dir"); return !!n && n.tipo === "dir"; } },
  { nivel: 1, xp: 40, titulo: "Arquivo vazio (Linux)", descricao: "Crie o arquivo <b>rascunho.txt</b> (comando Linux).", dicas: ["`touch` cria um arquivo vazio.", "A forma é: touch <nome-do-arquivo>"], solucao: ["touch rascunho.txt"], validar: (c) => { const n = _fsno(c, "rascunho.txt"); return !!n && n.tipo === "arquivo"; } },

  // ----- médio -----
  { nivel: 2, xp: 50, titulo: "Suba uma t3.micro", descricao: "Suba uma instância <b>t3.micro</b>.", dicas: ["run-instances --instance-type t3.micro"], solucao: ["aws ec2 run-instances --image-id ami-0abcd1234ef567890 --instance-type t3.micro"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "ec2", "run-instances") && cmd.flags["instance-type"] === "t3.micro" },
  ...
  { nivel: 2, xp: 60, titulo: "Site sincronizado", descricao: "Crie o bucket <b>tr-site</b> e sincronize a pasta <b>./site</b> nele.", dicas: ["mb + aws s3 sync <site> s3://<nome-do-bucket>"], solucao: ["aws s3 mb s3://tr-site", "aws s3 sync ./site s3://tr-site"], validar: (c) => { const b = c.s3.buckets["tr-site"]; return !!b && !!b.objetos["index.html"]; } },
  ...
  { nivel: 2, xp: 60, titulo: "Copie um arquivo (Linux)", descricao: "Copie o <b>relatorio.csv</b> para <b>copia.csv</b> (comando Linux).", dicas: ["cp <origem> <destino>"], solucao: ["cp relatorio.csv copia.csv"], validar: (c) => { const n = _fsno(c, "copia.csv"); return !!n && n.tipo === "arquivo"; } },
  { nivel: 2, xp: 60, titulo: "Proteja a chave (Linux)", descricao: "Aplique <b>chmod 600</b> no <b>labsuser.pem</b>.", dicas: ["chmod <permissão> <arquivo>", "6 = rw- (ler + escrever); 0 = nada."], solucao: ["chmod 600 labsuser.pem"], validar: (c) => { const n = _fsno(c, "labsuser.pem"); return !!n && n.modo === "600"; } },
  ...
  { nivel: 3, xp: 80, titulo: "Salve sua identidade", descricao: "Salve a saída do sts em <b>tr-id.json</b> com redirecionamento.", dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws sts help", "A forma do comando é: aws sts get-caller-identity > <arquivo>"], solucao: ["aws sts get-caller-identity > tr-id.json"], validar: (c) => _arq(c, "tr-id.json") },
  ...
  { nivel: 3, xp: 90, titulo: "Tabela descartável", descricao: "Crie a tabela <b>tr-descarte</b> (id, S) e em seguida <b>apague</b> ela.", dicas: ["create-table + delete-table"], solucao: ["aws dynamodb create-table --table-name tr-descarte --attribute-definitions AttributeName=id,AttributeType=S --key-schema AttributeName=id,KeyType=HASH --billing-mode PAY_PER_REQUEST", "aws dynamodb delete-table --table-name tr-descarte"], validar: (c, cmd, ok) => ok && ehCmd(cmd, "dynamodb", "delete-table") && !c.dynamodb.tabelas["tr-descarte"] },
  ...
  { nivel: 3, xp: 90, titulo: "Cace no log (Linux)", descricao: "Mostre as linhas com <b>erro</b> no <b>logs/app.log</b> usando grep.", dicas: ["grep <padrão> <arquivo>"], solucao: ["grep erro logs/app.log"], validar: (c, cmd, ok) => ok && cmd && cmd.servico === "linux" && cmd.sub === "grep" },
  ...
  { nivel: 2, xp: 50, titulo: "Renomeie (Linux)", descricao: "Crie o arquivo <b>tr-old.txt</b> e renomeie para <b>tr-new.txt</b> (comandos Linux).", dicas: ["São dois passos: criar o arquivo (touch <arquivo>) e depois renomear (mv <de> <para>)."], solucao: ["touch tr-old.txt", "mv tr-old.txt tr-new.txt"], validar: (c) => !_fsno(c, "tr-old.txt") && !!_fsno(c, "tr-new.txt") },
