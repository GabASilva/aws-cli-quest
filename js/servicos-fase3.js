...
(function () {
  ...
  const DESAFIOS_FASE3 = [
    ...
    { id: "ecr-1", servico: "ecr", nivel: 1, xp: 50, titulo: "O armário de imagens",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ecr help"], solucao: ["aws ecr describe-repositories"],
    ...
    { id: "ecr-2", servico: "ecr", nivel: 1, xp: 70, titulo: "Crie o repositório",
      ...
      dicas: ["aws ecr create-repository --repository-name <nome>", "Repare na repositoryUri que volta — é ela que o ECS usa depois."],
    ...
    { id: "ecr-3", servico: "ecr", nivel: 2, xp: 70, titulo: "A senha do Docker",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws ecr help"], solucao: ["aws ecr get-login-password"],
    ...
    { id: "ecs-1", servico: "ecs", nivel: 1, xp: 50, titulo: "Onde os contêineres rodam",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws ecs help"], solucao: ["aws ecs list-clusters"],
    ...
    { id: "ecs-2", servico: "ecs", nivel: 1, xp: 70, titulo: "Crie o cluster da loja",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ecs help", "A forma do comando é: aws ecs create-cluster --cluster-name <nome>"],
    ...
    { id: "ecs-3", servico: "ecs", nivel: 2, xp: 90, titulo: "A receita do contêiner",
      ...
      dicas: ["`register-…` inscreve um recurso dentro de outro — veja a lista de comandos com: aws ecs help", "A forma do comando é: aws ecs register-task-definition --family <nome> --container-definitions <json do contêiner>"],
    ...
    { id: "ecs-4", servico: "ecs", nivel: 2, xp: 90, titulo: "Coloque no ar (serviço)",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ecs help", "A forma do comando é: aws ecs create-service --cluster <valor> --service-name <nome> --task-definition <valor> --desired-count <número>"],
    ...
    { id: "ecs-5", servico: "ecs", nivel: 2, xp: 60, titulo: "Confira o serviço",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws ecs help", "A forma do comando é: aws ecs describe-services --cluster <valor> --services <valor>"],
    ...
    { id: "ecs-6", servico: "ecs", nivel: 3, xp: 90, titulo: "Black Friday: escale pra 5",
      ...
      dicas: ["`update-…` altera algo que já existe — veja a lista de comandos com: aws ecs help", "A forma do comando é: aws ecs update-service --cluster <valor> --service <valor> --desired-count <número>"],
    ...
    { id: "ecs-7", servico: "ecs", nivel: 3, xp: 90, titulo: "Desligue o serviço",
      ...
      dicas: ["Primeiro: aws ecs update-service --cluster <valor> --service <valor> --desired-count <número>", "Depois: aws ecs delete-service --cluster <valor> --service <valor>"],
    ...
    { id: "ecs-8", servico: "ecs", nivel: 3, xp: 70, titulo: "Feche o cluster",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws ecs help", "A forma do comando é: aws ecs delete-cluster --cluster <valor>"],
    ...
    { id: "sec-1", servico: "secretsmanager", nivel: 1, xp: 50, titulo: "Segredos guardados",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws secretsmanager help"], solucao: ["aws secretsmanager list-secrets"],
    ...
    { id: "sec-2", servico: "secretsmanager", nivel: 1, xp: 70, titulo: "Guarde a senha do banco",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws secretsmanager help", "A forma do comando é: aws secretsmanager create-secret --name <nome> --secret-string <o segredo>"],
    ...
    { id: "sec-3", servico: "secretsmanager", nivel: 2, xp: 70, titulo: "Leia o segredo",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws secretsmanager help", "A forma do comando é: aws secretsmanager get-secret-value --secret-id <id>"],
    ...
    { id: "sec-4", servico: "secretsmanager", nivel: 2, xp: 80, titulo: "Troque a senha",
      ...
      dicas: ["`update-…` altera algo que já existe — veja a lista de comandos com: aws secretsmanager help", "A forma do comando é: aws secretsmanager update-secret --secret-id <id> --secret-string <o segredo>"],
    ...
    { id: "sec-5", servico: "secretsmanager", nivel: 3, xp: 90, titulo: "Apagar (com rede de proteção)",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws secretsmanager help", "A forma do comando é: aws secretsmanager delete-secret --secret-id <id> --recovery-window-in-days <número>"],
    ...
    { id: "sec-6", servico: "secretsmanager", nivel: 3, xp: 80, titulo: "Ops, era usado ainda!",
      ...
      dicas: ["`restore-…` recupera algo de um backup — veja a lista de comandos com: aws secretsmanager help", "A forma do comando é: aws secretsmanager restore-secret --secret-id <id>"],
    ...
    { id: "sfn-1", servico: "stepfunctions", nivel: 1, xp: 50, titulo: "Fluxos de trabalho",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws stepfunctions help"], solucao: ["aws stepfunctions list-state-machines"],
    ...
    { id: "sfn-2", servico: "stepfunctions", nivel: 2, xp: 100, titulo: "Monte o fluxo do pedido",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws stepfunctions help", "A forma do comando é: aws stepfunctions create-state-machine --name <nome> --definition <json do fluxo> --role-arn <arn>"],
    ...
    { id: "sfn-3", servico: "stepfunctions", nivel: 2, xp: 70, titulo: "Veja a receita",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws stepfunctions help", "A forma do comando é: aws stepfunctions describe-state-machine --state-machine-arn <arn>"],
    ...
    { id: "sfn-4", servico: "stepfunctions", nivel: 3, xp: 100, titulo: "Rode o fluxo",
      ...
      dicas: ["`start-…` põe pra rodar algo que já existe — veja a lista de comandos com: aws stepfunctions help", "A forma do comando é: aws stepfunctions start-execution --state-machine-arn <arn> --input <json de entrada>"],
    ...
    { id: "sfn-5", servico: "stepfunctions", nivel: 3, xp: 80, titulo: "Histórico de execuções",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws stepfunctions help", "A forma do comando é: aws stepfunctions list-executions --state-machine-arn <arn>"],
    ...
    { id: "sfn-6", servico: "stepfunctions", nivel: 3, xp: 80, titulo: "Desmonte o fluxo",
      ...
      dicas: ["Apagar é sempre `delete-…` — veja a lista de comandos com: aws stepfunctions help", "A forma do comando é: aws stepfunctions delete-state-machine --state-machine-arn <arn>"],
    ...
    { id: "eb-1", servico: "events", nivel: 1, xp: 50, titulo: "O despertador da nuvem",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws events help"], solucao: ["aws events list-rules"],
    ...
    { id: "eb-2", servico: "events", nivel: 2, xp: 80, titulo: "Agende a limpeza diária",
      ...
      dicas: ["`put-…` grava/substitui uma configuração (é o \"salvar\" do CLI) — veja a lista de comandos com: aws events help", "A forma do comando é: aws events put-rule --name <nome> --schedule-expression <cron ou rate>"],
    ...
    { id: "eb-3", servico: "events", nivel: 2, xp: 90, titulo: "Quem é chamado?",
      ...
      dicas: ["`put-…` grava/substitui uma configuração (é o \"salvar\" do CLI) — veja a lista de comandos com: aws events help", "A forma do comando é: aws events put-targets --rule <valor> --targets <Id=…>"],
    ...
    { id: "eb-4", servico: "events", nivel: 2, xp: 60, titulo: "Confirme o alvo",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws events help", "A forma do comando é: aws events list-targets-by-rule --rule <valor>"],
    ...
    { id: "eb-5", servico: "events", nivel: 3, xp: 80, titulo: "Pause sem apagar",
      ...
      dicas: ["`disable-…` desliga o serviço — veja a lista de comandos com: aws events help", "A forma do comando é: aws events disable-rule --name <nome>"],
    ...
    { id: "eb-6", servico: "events", nivel: 3, xp: 90, titulo: "Remova a regra de vez",
      ...
      dicas: ["Primeiro: aws events remove-targets --rule <valor> --ids <id>", "Depois: aws events delete-rule --name <nome>"],
