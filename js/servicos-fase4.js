...
(function () {
  ...
  const DESAFIOS_FASE4 = [
    ...
    { id: "eks-1", servico: "eks", nivel: 1, xp: 50, titulo: "Kubernetes gerenciado",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws eks help"], solucao: ["aws eks list-clusters"],
    ...
    { id: "eks-2", servico: "eks", nivel: 2, xp: 100, titulo: "Suba o cluster",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws eks help", "A forma do comando é: aws eks create-cluster --name <nome> --role-arn <arn> --resources-vpc-config <config da vpc>"],
    ...
    { id: "eks-3", servico: "eks", nivel: 2, xp: 70, titulo: "Detalhes do cluster",
      ...
      dicas: ["`describe-…` é o que mostra os detalhes/estado de um recurso — veja a lista de comandos com: aws eks help", "A forma do comando é: aws eks describe-cluster --name <nome>"],
    ...
    { id: "eks-4", servico: "eks", nivel: 2, xp: 90, titulo: "Conecte o kubectl",
      ...
      dicas: ["`update-…` altera algo que já existe — veja a lista de comandos com: aws eks help", "A forma do comando é: aws eks update-kubeconfig --name <nome>"],
    ...
    { id: "eks-5", servico: "eks", nivel: 3, xp: 100, titulo: "Onde os pods vão rodar",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws eks help", "A forma do comando é: aws eks create-nodegroup --cluster-name <nome> --nodegroup-name <nome> --node-role <valor> --subnets <duas sub-redes>"],
    ...
    { id: "eks-6", servico: "eks", nivel: 3, xp: 70, titulo: "Confira os nós",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws eks help", "A forma do comando é: aws eks list-nodegroups --cluster-name <nome>"],
    ...
    { id: "eks-7", servico: "eks", nivel: 3, xp: 90, titulo: "Desmonte na ordem certa",
      ...
      dicas: ["Primeiro: aws eks delete-nodegroup --cluster-name <nome> --nodegroup-name <nome>", "Depois: aws eks delete-cluster --name <nome>"],
    ...
    { id: "glue-1", servico: "glue", nivel: 1, xp: 50, titulo: "O catálogo de dados",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws glue help"], solucao: ["aws glue get-databases"],
    ...
    { id: "glue-2", servico: "glue", nivel: 2, xp: 80, titulo: "Crie o banco do catálogo",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws glue help", "A forma do comando é: aws glue create-database --database-input <json do banco>"],
    ...
    { id: "glue-3", servico: "glue", nivel: 2, xp: 90, titulo: "Descreva a tabela de vendas",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws glue help", "A forma do comando é: aws glue create-table --database-name <nome> --table-input <json da tabela>"],
    ...
    { id: "glue-4", servico: "glue", nivel: 2, xp: 60, titulo: "Confira o catálogo",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws glue help", "A forma do comando é: aws glue get-tables --database-name <nome>"],
    ...
    { id: "glue-6", servico: "glue", nivel: 3, xp: 80, titulo: "Solte o robô",
      ...
      dicas: ["`start-…` põe pra rodar algo que já existe — veja a lista de comandos com: aws glue help", "A forma do comando é: aws glue start-crawler --name <nome>"],
    ...
    { id: "ath-1", servico: "athena", nivel: 1, xp: 60, titulo: "Onde os resultados caem",
      ...
      dicas: ["Veja os comandos disponíveis com: aws s3 help", "A forma do comando é: aws s3 mb s3://<nome-do-bucket>"],
    ...
    { id: "ath-2", servico: "athena", nivel: 2, xp: 100, titulo: "Sua primeira consulta",
      ...
      dicas: ["`start-…` põe pra rodar algo que já existe — veja a lista de comandos com: aws athena help", "A forma do comando é: aws athena start-query-execution --query-string <a consulta SQL> --result-configuration <valor>"],
    ...
    { id: "ath-3", servico: "athena", nivel: 2, xp: 70, titulo: "A consulta terminou?",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws athena help", "A forma do comando é: aws athena get-query-execution --query-execution-id <id>"],
    ...
    { id: "ath-4", servico: "athena", nivel: 3, xp: 100, titulo: "Traga as linhas",
      ...
      dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws athena help", "A forma do comando é: aws athena get-query-results --query-execution-id <id>"],
    ...
    { id: "ath-5", servico: "athena", nivel: 3, xp: 80, titulo: "Histórico de consultas",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws athena help"], solucao: ["aws athena list-query-executions"],
    ...
    { id: "kms-1", servico: "kms", nivel: 1, xp: 50, titulo: "As chaves da conta",
      ...
      dicas: ["Pra ver o que já existe, o verbo costuma ser `list-…` — veja a lista de comandos com: aws kms help"], solucao: ["aws kms list-keys"],
    ...
    { id: "kms-2", servico: "kms", nivel: 1, xp: 70, titulo: "Crie sua chave",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws kms help", "A forma do comando é: aws kms create-key --description <descrição>"],
    ...
    { id: "kms-3", servico: "kms", nivel: 2, xp: 80, titulo: "Dê um apelido pra chave",
      ...
      dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws kms help", "A forma do comando é: aws kms create-alias --alias-name <nome> --target-key-id <id>"],
    ...
    { id: "kms-4", servico: "kms", nivel: 2, xp: 90, titulo: "Cifre um segredo",
      ...
      dicas: ["Veja os comandos disponíveis com: aws kms help", "A forma do comando é: aws kms encrypt --key-id <id> --plaintext <o texto a cifrar>"],
    ...
    { id: "kms-5", servico: "kms", nivel: 3, xp: 100, titulo: "Volte ao texto original",
      ...
      dicas: ["Veja os comandos disponíveis com: aws kms help", "A forma do comando é: aws kms decrypt --ciphertext-blob <valor>"],
