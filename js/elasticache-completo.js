...
(function () {
  ...
  Object.assign(SERVICOS.elasticache, {
    ...
    "describe-events": (conta, pos, flags) => {
      const s = st(conta);
      const dias = flags.duration ? parseInt(flags.duration, 10) : null;
      avisarClimb(
      ...
      return js({ Events: s.eventos.map((e) => ({
  ...
  const NOVAS = [
    ...
    { id: "cache-5", servico: "elasticache", nivel: 2, xp: 65, titulo: "Confira onde o cache pode nascer",
      ...
      dicas: ["`describe-…` lista o que existe — veja a lista de comandos com: aws elasticache help", "A forma é: aws elasticache describe-cache-subnet-groups"],
    ...
    { id: "cache-7", servico: "elasticache", nivel: 3, xp: 80, titulo: "O failover está mesmo ligado?",
      ...
      dicas: ["`describe-…` mostra o estado — veja a lista de comandos com: aws elasticache help", "A forma é: aws elasticache describe-replication-groups"],
    ...
    { id: "cache-9", servico: "elasticache", nivel: 3, xp: 70, titulo: "Quando foi o último backup?",
      ...
      dicas: ["`describe-…` lista o que existe — veja a lista de comandos com: aws elasticache help", "A forma é: aws elasticache describe-snapshots"],
    ...
    { id: "cache-10", servico: "elasticache", nivel: 3, xp: 85, titulo: "O que aconteceu de madrugada",
      descricao: "O sistema ficou lento às 3 da manhã e ninguém mexeu em nada. <b>Veja os eventos</b> do serviço nas últimas <b>24 horas</b> — failover, nó substituído e manutenção aparecem aqui. <small>(a duração é em MINUTOS: 1440)</small>",
      dicas: ["`describe-events` mostra o que o serviço fez sozinho — veja a lista de comandos com: aws elasticache help", "A forma é: aws elasticache describe-events --duration 1440"],
      solucao: ["aws elasticache describe-events --duration 1440"],
      validar: (c, cmd, ok) => ok && ehCmd(cmd, "elasticache", "describe-events") },
  ];
