...
(function () {
  ...
  const DESAFIOS_FASE8 = [
    ...
    { id: "gd-1", servico: "guardduty", nivel: 1, xp: 60, titulo: "Vigia que nunca dorme",
      ...
      dicas: ["aws guardduty create-detector --enable"], solucao: ["aws guardduty create-detector --enable"],
    ...
    { id: "gd-2", servico: "guardduty", nivel: 2, xp: 80, titulo: "Qual é o ID do vigia?",
      ...
      dicas: ["aws guardduty list-detectors"], solucao: ["aws guardduty list-detectors"],
    ...
    { id: "gd-3", servico: "guardduty", nivel: 3, xp: 100, titulo: "O que ele encontrou?",
      ...
      dicas: ["aws guardduty list-findings --detector-id <detector-id>"],
    ...
    { id: "insp-1", servico: "inspector2", nivel: 1, xp: 60, titulo: "Caça-vulnerabilidades",
      ...
      dicas: ["aws inspector2 enable --resource-types EC2"], solucao: ["aws inspector2 enable --resource-types EC2"],
    ...
    { id: "insp-2", servico: "inspector2", nivel: 2, xp: 90, titulo: "Quais brechas ele achou?",
      ...
      dicas: ["aws inspector2 list-findings"], solucao: ["aws inspector2 list-findings"],
    ...
    { id: "macie-1", servico: "macie2", nivel: 1, xp: 60, titulo: "Tem dado sensível vazando?",
      ...
      dicas: ["aws macie2 enable-macie"], solucao: ["aws macie2 enable-macie"],
    ...
    { id: "waf-1", servico: "wafv2", nivel: 1, xp: 60, titulo: "Firewall da aplicação",
      ...
      dicas: [`aws wafv2 create-web-acl --name protege-loja --scope REGIONAL --default-action Allow={} --visibility-config SampledRequestsEnabled=true,CloudWatchMetricsEnabled=true,MetricName=protege-loja`],
    ...
    { id: "waf-2", servico: "wafv2", nivel: 2, xp: 80, titulo: "Confira o firewall",
      ...
      dicas: ["aws wafv2 list-web-acls --scope REGIONAL"], solucao: ["aws wafv2 list-web-acls --scope REGIONAL"],
    ...
    { id: "shield-1", servico: "shield", nivel: 1, xp: 60, titulo: "Escudo contra DDoS",
      ...
      dicas: ["aws shield describe-subscription"], solucao: ["aws shield describe-subscription"],
    ...
    { id: "cfg-1", servico: "configservice", nivel: 1, xp: 60, titulo: "Câmera de segurança da conta",
      ...
      dicas: [`aws configservice put-configuration-recorder --configuration-recorder name=default,roleARN=arn:aws:iam::123456789012:role/config-role`],
    ...
    { id: "cfg-2", servico: "configservice", nivel: 2, xp: 80, titulo: "Ligue a gravação",
      ...
      dicas: ["aws configservice start-configuration-recorder --configuration-recorder-name default"],
    ...
    { id: "cfg-3", servico: "configservice", nivel: 3, xp: 100, titulo: "Regra de conformidade",
      ...
      dicas: [`aws configservice put-config-rule --config-rule '{"ConfigRuleName":"s3-encriptado","Source":{"Owner":"AWS","SourceIdentifier":"S3_BUCKET_SERVER_SIDE_ENCRYPTION_ENABLED"}}'`],
