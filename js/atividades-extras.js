...
const EXTRAS = [
  ...
  },
  {
    ...
    dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-user --user-name <nome>"],
  ...
  },
  {
    ...
    dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws ec2 help", "A forma do comando é: aws ec2 create-key-pair --key-name <nome>"],
  ...
  },
  {
    ...
    dicas: ["Criar recurso no AWS CLI é sempre `create-…` — veja a lista de comandos com: aws iam help", "A forma do comando é: aws iam create-group --group-name <nome>"],
  ...
  },
  {
    ...
    dicas: ["`get-…` busca um item específico (você diz qual) — veja a lista de comandos com: aws sts help"],
