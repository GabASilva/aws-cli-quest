...
(function () {
  ...
  const DESAFIOS_FASE9 = [
    ...
    { id: "rek-1", servico: "rekognition", nivel: 1, xp: 60, titulo: "IA que enxerga",
      ...
      dicas: [`aws rekognition detect-labels --image '{"S3Object":{"Bucket":"meu-bucket","Name":"foto.jpg"}}'`],
    ...
    { id: "rek-2", servico: "rekognition", nivel: 2, xp: 80, titulo: "Leia o texto da imagem",
      ...
      dicas: [`aws rekognition detect-text --image '{"S3Object":{"Bucket":"meu-bucket","Name":"placa.jpg"}}'`],
    ...
    { id: "trad-1", servico: "translate", nivel: 1, xp: 60, titulo: "Tradutor sob demanda",
      ...
      dicas: ["aws translate translate-text --text \"hello world\" --source-language-code en --target-language-code pt"],
    ...
    { id: "polly-1", servico: "polly", nivel: 1, xp: 70, titulo: "Texto vira voz",
      ...
      dicas: ["aws polly synthesize-speech --text \"Bem-vindo ao CLImb\" --output-format mp3 --voice-id Camila fala.mp3"],
    ...
    { id: "polly-2", servico: "polly", nivel: 2, xp: 70, titulo: "Quais vozes existem?",
      ...
      dicas: ["aws polly describe-voices --language-code pt-BR"],
    ...
    { id: "comp-1", servico: "comprehend", nivel: 1, xp: 60, titulo: "O cliente está feliz?",
      ...
      dicas: ["aws comprehend detect-sentiment --text \"adorei o produto, excelente\" --language-code pt"],
    ...
    { id: "comp-2", servico: "comprehend", nivel: 2, xp: 80, titulo: "Quem e onde?",
      ...
      dicas: ["aws comprehend detect-entities --text \"A AWS tem data centers no Brasil\" --language-code pt"],
    ...
    { id: "bed-1", servico: "bedrock", nivel: 1, xp: 70, titulo: "O balcão de IA generativa",
      ...
      dicas: ["aws bedrock list-foundation-models"], solucao: ["aws bedrock list-foundation-models"],
    ...
    { id: "kin-1", servico: "kinesis", nivel: 1, xp: 60, titulo: "Cano de dados ao vivo",
      ...
      dicas: ["aws kinesis create-stream --stream-name eventos-loja --shard-count 1"],
    ...
    { id: "kin-2", servico: "kinesis", nivel: 2, xp: 90, titulo: "Jogue um evento no cano",
      ...
      dicas: ["aws kinesis put-record --stream-name eventos-loja --data \"clique-produto-42\" --partition-key user1"],
    ...
    { id: "kin-3", servico: "kinesis", nivel: 3, xp: 80, titulo: "Feche o cano",
      ...
      dicas: ["aws kinesis delete-stream --stream-name eventos-loja"],
    ...
    { id: "rs-1", servico: "redshift", nivel: 1, xp: 60, titulo: "Data warehouse",
      ...
      dicas: ["aws redshift describe-clusters"], solucao: ["aws redshift describe-clusters"],
    ...
    { id: "rs-2", servico: "redshift", nivel: 2, xp: 110, titulo: "Suba o warehouse",
      ...
      dicas: ["aws redshift create-cluster --cluster-identifier analitica-loja --node-type dc2.large --master-username admin --master-user-password SenhaExemplo123 --number-of-nodes 1"],
    ...
    { id: "rs-3", servico: "redshift", nivel: 3, xp: 90, titulo: "Derrube o warehouse",
      ...
      dicas: ["aws redshift delete-cluster --cluster-identifier analitica-loja --skip-final-cluster-snapshot"],
