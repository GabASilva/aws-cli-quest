...
function carregarSimulados(raiz) {
  ...
  return {
    ...
    // usado pela rota /api/simulados/banco: o app precisa dos três mapas de
    // fonte, e os arquivos deles deixaram de ser servidos ao público.
    fonteFallback: caixa.SIMULADOS_FONTE_FALLBACK || {},
  };
}
